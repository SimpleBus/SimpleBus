...
final class Events
{
     ...
     */
    public const MESSAGE_CONSUMED = 'simple_bus.rabbit_mq_bundle_bridge.message_consumed';

    /**
     * This event will be dispatched whenever an AMQP message could not be processed by the message bus.
     */
    public const MESSAGE_CONSUMPTION_FAILED = 'simple_bus.rabbit_mq_bundle_bridge.message_consumption_failed';
}
